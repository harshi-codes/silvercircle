...
export default function VRMemoriesPage() {
  ...
  const sampleMemories: Memory[] = [
    ...
    },
    {
      ...
      description: "Our first trip to Europe with the grandchildren. The Eiffel Tower was breathtaking!",
      location: "Paris, France",
      date: "1995",
      imageUrl: "/memories/paris-vacation.jpg",
      vrImageUrl: "/memories/vr/paris-vacation-360.jpg",
      category: "travel",
      isPublic: false,
      likes: 12,
      views: 67,
      ...
      tags: ["travel", "paris", "family", "vacation"],
    },
    {
      id: "4",
